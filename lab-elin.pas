...
PROCEDURE initiate;
         BEGIN
               ...
               Write('                  ');
               GotoXY(1,1);
               Write('Giv Y-koordinaten för x=0  ');
               Read(y);
               yo:=y;
               ...
               Read(uo);
               IF rq<0 THEN GotoXY(1,1) ELSE  Writeln;
               Write('      Giv elektronkällans avstånd från y-axeln  ');
               Read(xbi);
               IF rq<0 THEN GotoXY(1,1) ELSE  Writeln;
               Write('       Utskrift av data på plotter?   J/N          ');
               Read(sluv);  Writeln;
              ...
              BEGIN  rq:=1;
                   ...
                   REPEAT
                         ...
                         BEGIN
                              ...
                              GotoXY(1,1);
                              Write('x för bildpunkt b=',xbild:3:2);
                              Write('     y för x=N1-1   y2=',yslut:1:2);
                              IF fl<0 THEN
                              BEGIN GotoXY(1,25);
                                    hb:=xbild+yo*vx/vy;
                                    Write('x för bildhpl  hb=',hb:5:2);
                                    fb:=xbild-hb;
                                    Write('      brännvidden  fb=',fb:5:2);
                              END;
                              IF gl<0 THEN
                              BEGIN GotoXY(1,25);
                                    hk:=yny/yo*xbi-xbi;
                                    Write('x för objekthpl  ho=',hk:5:2);
                                    fo:=xbi+hk;
                                    Write('     brännvidden fo=',fo:5:2);
...
PROCEDURE ekviplot;
          ...
          BEGIN ClrScr;
               ...
               IF v2<v1
                  ...
                  Write('För fortsatt beräkning slå godtycklig tangent');
                  Read(fortsatt);
          END;
...
BEGIN
      ...
      END;
      close(eslask);
      Writeln('Är Rolandplottern inkopplad?  J/N');
      Read(rpl);  Writeln;
      IF rpl='j' THEN rpl:='J';
      IF rpl='J' THEN
